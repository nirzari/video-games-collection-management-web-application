...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<?php 
			...
			$query = $db->prepare('SELECT game_release.ReleaseID , game.GameTitle, console.ConsoleName, publisher.PublisherName from game_release INNER JOIN game ON game.GameID = game_release.GameID INNER JOIN console ON console.ConsoleID = game_release.ConsoleID INNER JOIN publisher ON publisher.PublisherID = game_release.PublisherID');
			$query->execute();
...
?>	
	...
	<table border="1px">
		...
		<?php 
			...
			<td><a href="AddCollection.php?rid=<?php echo $row["ReleaseID"] ?>"  >select</a></td>
